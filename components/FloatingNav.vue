<template>
  <nav class="fixed right-6 top-1/2 -translate-y-1/2 z-40 hidden md:flex flex-col gap-4">
    ...
    >
      ...
      <!-- Dot -->
      <div
        class="w-2.5 h-2.5 rounded-full border transition-all duration-300 cubic-bezier(0.4, 0, 0.2, 1)"
        :class="activeSection === section.id
          ? 'bg-gold border-gold scale-125 shadow-[0_0_8px_rgba(201,168,76,0.6)]'
