<template>
  <section id="countdown" class="relative py-24 md:py-32 overflow-hidden" style="background-color: #050D1A">
    <!-- Background ornament -->
    <div class="absolute inset-0 pointer-events-none overflow-hidden">
      <div class="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-2xl h-px bg-gradient-to-r from-transparent via-gold/30 to-transparent" />
      <div class="absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-2xl h-px bg-gradient-to-r from-transparent via-gold/30 to-transparent" />
    </div>
    ...
    <div class="max-w-4xl mx-auto px-6 text-center">
      ...
      <div class="grid grid-cols-4 gap-4 md:gap-8 max-w-2xl mx-auto">
        ...
        >
          <!-- Number box -->
          <div
            class="relative w-full aspect-square max-w-[100px] mx-auto flex items-center justify-center mb-3 rounded"
            style="
...
const countdownUnits = computed(() => [
  { value: days.value, label: 'Hari' },
  { value: hours.value, label: 'Jam' },
  { value: minutes.value, label: 'Menit' },
  { value: seconds.value, label: 'Detik' },
])
